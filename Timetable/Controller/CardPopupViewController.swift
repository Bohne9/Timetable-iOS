...
//    }
    ...
    @objc func handlePan(_ gesture: UIPanGestureRecognizer) {
        ...
        if transition.y > 0 {
            ...
            ViewController.controller.scaleDown(percent)
        }
    ...
    func present(){
        ViewController.controller.presentCardPopupViewController(self)
    }
    
    func dismiss(){
        ViewController.controller.dismissCardPopupViewController(self)
    }
