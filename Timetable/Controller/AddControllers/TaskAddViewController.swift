...
class TaskAddViewController: AddViewController {

    private lazy var titleView = TaskAddTopTableViewHeader(superview: view)
    ...
    override func setupUserInterface() {
        ...
        topSectionColor = UIColor(hexString: "#60a3bc")
...
extension TaskAddViewController: AddTopHeaderActionDelegate {
