...
class OldViewController : UIViewController, DataUpdateDelegate, UIScrollViewDelegate, UIGestureRecognizerDelegate{
    
    static var controller: OldViewController!
...
//    var dayIndicator:r DayIndicator!
    ...
    var lessonAddView:  OldLessonAddViewController?
    ...
    override func viewDidLoad() {
        ...
        OldViewController.controller = self
...
//            vc.topConstraint.isActive = true
    ...
    func dismissCardPopupViewController(_ vc: CardPopupViewController){
        ...
        UIView.animate(withDuration: 0.35, animations: {
            OldViewController.controller.scaleDown(0)
            vc.fadeOut()
            vc.view.layoutIfNeeded()
            self.view.layoutIfNeeded()
        }){ _ in
    ...
    func presentAddViewController() {
        if lessonAddView == nil {
            lessonAddView = OldLessonAddViewController()
        }
