...
class TaskMenuSectionView: MenuSectionView, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        OldViewController.controller.subjectViewController.open(task: cell.task!, subject: cell.subject!)
//        ViewController.controller.present(ViewController.controller.subjectViewController, animated: true, completion: nil)
        OldViewController.controller.presentChild(viewController: OldViewController.controller.subjectViewController)
        OldViewController.controller.subjectViewController.present()
